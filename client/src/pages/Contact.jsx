  ...
  return (
    <div className="mt-10 px-8 py-16">
      ...
      <div className="text-center mb-10">
        <h1 className="text-2xl font-semibold uppercase text-[#243654] relative inline-block">
          Contact Us
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start max-w-7xl mx-auto">
        ...
        <div className="space-y-6 text-left">
          <p className="text-gray-600 leading-relaxed">
            ...
            We’re always happy to hear from you! Reach out through any of the options below.
          </p>

          <div>
            <h2 className="text-xl font-semibold text-[#243654] mb-2">Our Address</h2>
            <p className="text-gray-700">
              FreshKart HQ, Sector 21, Gurgaon, Haryana, India
            </p>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-[#243654] mb-2">Email Us</h2>
            <a
          ...
          <div>
            <h2 className="text-xl font-semibold text-[#243654] mb-2">Call Us</h2>
            <p className="text-gray-700">+91 90982 34675</p>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-[#243654] mb-2">Working Hours</h2>
